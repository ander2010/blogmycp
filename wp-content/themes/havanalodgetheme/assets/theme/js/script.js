(function($){
    ...
    (function(){
        var center = [ parseFloat(jQuery(".mbr-map").attr('data-lat')) , parseFloat(jQuery(".mbr-map").attr('data-lng'))];
        var default_icon = jQuery(".mbr-map").attr('data-icons');
        var zoom = parseInt(jQuery(".mbr-map").attr('data-zoom'));
