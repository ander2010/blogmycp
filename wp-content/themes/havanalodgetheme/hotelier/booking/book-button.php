...
<div id="request-booking" class="booking__section booking__section--request-booking">
	...
	<div class="form-row">
		...
		<?php echo apply_filters( 'hotelier_book_button_html', '<input type="submit" class="btn btn-sm btn-primary" name="hotelier_booking_book_button" id="book-button" value="' . esc_attr( $button_text ) . '" />' ); ?>
