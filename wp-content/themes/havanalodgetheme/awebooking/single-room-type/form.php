		...
		<div class="awebooking-check-form__content">
			<div class="awebooking-field">
				...
				<div class="awebooking-field-group">
					...
					<input style="font-size: 1rem;" type="text" class="awebooking-datepicker awebooking-input awebooking-start-date" data-init="datepicker" data-alt-field="#start-date" data-date-format="<?php echo esc_attr( $date_format ); ?>" placeholder="<?php esc_html_e( 'Arrival Date', 'awebooking' ); ?>">
			...
			<div class="awebooking-field">
				...
				<div class="awebooking-field-group">
					<i class="awebookingf awebookingf-calendar"></i>
					<input style="font-size: 1rem;" type="text" class="awebooking-datepicker awebooking-input awebooking-end-date" data-init="datepicker" data-alt-field="#end-date" data-date-format="<?php echo esc_attr( $date_format ); ?>" placeholder="<?php esc_html_e( 'Departure Date', 'awebooking' ); ?>">
				...
				<div class="awebooking-sidebar-group">
					...
					<div class="awebooking-field">
						...
						<div class="awebooking-field-group">
							...
							<select name="adults" class="awebooking-select" style="font-size: 1rem;">
					...
					<div class="awebooking-field">
						...
						<div class="awebooking-field-group">
							<i class="awebookingf awebookingf-select"></i>
							<select name="children" class="awebooking-select" style="font-size: 1rem;">
			...
			<div class="awebooking-field mb-0">
				<div class="awebooking-field-group">
					<button type="submit" class="btn btn-primary awebooking-btn"><?php esc_html_e( 'CHECK AVAILABILITY', 'awebooking' ); ?></button>
				</div>
			</div>
		</div>
	</div>
