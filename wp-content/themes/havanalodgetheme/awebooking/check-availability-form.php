		...
		<div class="awebooking-check-form__content">
			<div class="awebooking-field">
				...
				<div class="awebooking-field-group">
					...
					<input type="text" class="awebooking-datepicker awebooking-input awebooking-start-date" data-init="datepicker" data-alt-field="#start-date" data-date-format="<?php echo esc_attr( $date_format ); ?>" placeholder="<?php esc_html_e( 'Arrival Date', 'awebooking' ); ?>">
			...
			<div class="awebooking-field">
				...
				<div class="awebooking-field-group">
					...
					<select name="location" class="awebooking-select">
						...
						<option value="<?php echo esc_attr( $location->slug ); ?>" <?php echo isset( $_GET['location'] ) ? selected( $_GET['location'], $location->slug, false ) : ''; ?>><?php echo esc_attr( $location->name ); ?></option>
						<?php endforeach; ?>
					</select>
				</div>
			</div>
