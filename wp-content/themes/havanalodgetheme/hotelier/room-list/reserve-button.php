...
<div id="reserve-rooms-button">
	...
	<?php echo apply_filters( 'hotelier_reserve_button_html', '<input type="submit" class="btn btn-sm btn-primary pull-right" name="hotelier_reserve_rooms_button" id="reserve-button" value="' . esc_html__( 'Reserve', 'wp-hotelier' ) . '" />' ); ?>
